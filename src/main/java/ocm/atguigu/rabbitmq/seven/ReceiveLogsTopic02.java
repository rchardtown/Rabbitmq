...
public class ReceiveLogsTopic02 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        channel.basicConsume(queueName, true,deliverCallback, (messageSequence)->{
            messageSequenceList.add(messageSequence);
            System.out.println("取消的消息序列号为: "+messageSequence);
        });
    }
